...
Future<RtcEngineEventHandler> rtcEngineEventHandler(
  ...
  return RtcEngineEventHandler(
    ...
    onFirstLocalVideoFramePublished: (source, elapsed) {
      agoraEventHandlers.onFirstLocalVideoFramePublished?.call(source as VideoSourceType, elapsed);
    },
    ...
    onLocalVideoStats: (source, stats) {
      agoraEventHandlers.onLocalVideoStats?.call(source as VideoSourceType, stats);
    },
    ...
    // REMOVED: onExtensionError - no longer exists in agora_rtc_engine 6.5.3
    // REMOVED: onExtensionEvent - no longer exists in agora_rtc_engine 6.5.3
    // REMOVED: onExtensionStarted - no longer exists in agora_rtc_engine 6.5.3
    // REMOVED: onExtensionStopped - no longer exists in agora_rtc_engine 6.5.3

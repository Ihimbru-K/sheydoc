...
class DoctorVideoPatientsScreen extends StatelessWidget {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 8.h),
                    Text(
                      'You can only call patients with confirmed appointments',
                      style: TextStyle(
                        fontSize: 14.sp,
            ...
            children: [
              ...
              Container(
                ...
                child: IconButton(
                  ...
                  onPressed: () => _startChat(context, patientId),
                ),
              ),
            ],
          ),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 8.h),
          Text(
            'You need confirmed appointments\nto start video calls',
            style: TextStyle(
              fontSize: 14.sp,
  ...
  void _startVideoCall(
    ...
    // 🔍 DEBUGGING
    print('');
    print('🏥 DOCTOR STARTING VIDEO CALL');
...
//                     context,
//                     MaterialPageRoute(builder: (context) => DoctorVideoPatientsScreen()),
//                   ),
//
...
//     final channelName = 'appointment_$appointmentId';
//
//     // TODO: Navigate to actual video call screen
//     // Navigator.push(
//     //   context,
//     //   MaterialPageRoute(
//     //     builder: (context) => VideoCallScreen(

    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        for (var doc in snapshot.data!.docs) {
          ...
          if (!patientsMap.containsKey(data['patientId'])) {
            patientsMap[data['patientId']] = data;
          }
        }
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) => _buildPatientCard(patientsList[index]),
        );
      },
    );
  }
  ...
  Widget _buildBookedTab() {
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
          return _buildEmptyState('No confirmed appointments');
        }

        return ListView.builder(
          padding: EdgeInsets.all(16.w),
          itemCount: snapshot.data!.docs.length,
          itemBuilder: (context, index) => _buildBookedAppointmentCard(

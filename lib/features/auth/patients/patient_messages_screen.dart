  ...
  Widget _buildChatCard(
    ...
    return FutureBuilder<DocumentSnapshot>(
      ...
      builder: (context, userSnapshot) {
        ...
        final userName = userData?['name'] ?? userData?['email'] ?? 'Doctor';
                  ...
                  Expanded(
                    child: StreamBuilder<QuerySnapshot>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        // Get unique doctors
                        final doctorsMap = <String, Map<String, dynamic>>{};
                        for (var doc in snapshot.data!.docs) {
                          final data = doc.data() as Map<String, dynamic>;
                          final doctorId = data['doctorId'];
                          if (!doctorsMap.containsKey(doctorId)) {
                            doctorsMap[doctorId] = data;
                          }
                        }
                        ...
                        if (doctorsMap.isEmpty) {
                          return Center(
                            child: Text(
                              'No doctors yet. Book an appointment first!',
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ListTile(
                              ...
                              title: Text(doctor['doctorName'] ?? 'Doctor'),
                              subtitle: Text(doctor['specialty'] ?? 'General Practitioner'),
                              onTap: () async {

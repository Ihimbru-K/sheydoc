...
class _PatientHomeScreenState extends State<PatientHomeScreen> {
  ...
  String _userName = 'Patient'; // Default value
  ...
  // ✅ NEW: Fetch user name from auth service
  Future<void> _fetchUserName() async {
    try {
      ...
      if (user != null) {
        ...
        // Using the existing AuthService getUserProfile method
        ...
        if (mounted && userProfile != null) {
          setState(() {
            _userName = userProfile['name'] ?? 'Patient';
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            // ✅ MODIFIED: Display username instead of email
                            _isLoadingUserName
                                ? SizedBox(
                              height: 18.sp,
                              width: 18.sp,

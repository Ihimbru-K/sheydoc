...
//       final userData = userDoc.data()!;
//       final personalComplete = userData['personalInfoComplete'] ?? false;
//       final professionalComplete = userData['professionalInfoComplete'] ??
//           false;
//       final availabilityComplete = userData['availabilityComplete'] ?? false;
//
//       if (personalComplete && professionalComplete && availabilityComplete) {
...
//     required double baseFee,
//   }) async {
//     final availability = schedule.map((day, ranges) =>
//         MapEntry(
//           day,
//           ranges.map((r) =>
//           {
//             "start":
//             "${r.start.hour.toString().padLeft(2, '0')}:${r.start.minute
//                 .toString().padLeft(2, '0')}",
//             "end":
//             "${r.end.hour.toString().padLeft(2, '0')}:${r.end.minute.toString()
//                 .padLeft(2, '0')}",
//           }).toList(),
//         ));
//
...
//       "defaultDuration": defaultDuration,
//       "baseFee": baseFee,
//       "availabilityComplete": true, // Mark this step as complete
//     });
//
//     // Check if profile is now complete
//     await saveUserProfile(uid: uid, data: {});
//   }
//
//   // ✅ Sign out
//   Future<void> signOut() async {
